...
It is based on default `whitespace-line' face.")
  ...
  ;; NOTE: I turned off automatic activation of copilot for now because I didn't find it very useful.
  ...
  (defun my/cheatsheet ()
    ...
    (let* ((buffer-name "*Cheatsheet*")
           ...
           `("Martin's (spac)emacs cheatsheet!!"
             ...
             ""
             " - `M-%`       -> query replace (in region if selected)"
             ""
